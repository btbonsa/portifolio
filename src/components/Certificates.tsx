  ...
  const certificates = [
    {
      ...
      date: 'January 2024',
      description: 'Description of the certification and what skills or knowledge it validates.',
      icon: '🏆',
    ...
    },
    {
      ...
      issuer: 'Issuing Organization',
      date: 'December 2023',
      description: 'Brief description of this professional certification or achievement.',
      icon: '🎓',
      link: 'https://certificate-link.com',
    },
    {
      ...
      issuer: 'Issuing Organization',
      date: 'September 2023',
      description: 'Add more certificates to demonstrate your continuous learning and expertise.',
      icon: '⭐',
      link: 'https://certificate-link.com',
    },
    {
